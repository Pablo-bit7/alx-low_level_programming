...
/**
* make_buffer - This allocates exactly 1024 bytes for a buffer.
* @file: Name of file buffer is to store chars for.
*
...
/**
* main - This copies contents of a file to another.
